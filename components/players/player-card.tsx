...
import { Mail, Phone, MapPin, Edit, Trash2, CheckCircle, XCircle } from "lucide-react"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {player.rating && <div className="text-sm text-muted-foreground">Rating: {player.rating}</div>}
            </div>
          </div>
